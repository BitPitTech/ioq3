...
void UI_SPSkillMenu_Cache( void ) {
	...
	skillMenuInfo.nightmareSound = trap_S_RegisterSound( "sound/misc/nightmare.opus", qfalse );
	skillMenuInfo.silenceSound = trap_S_RegisterSound( "sound/misc/silence.opus", qfalse );
}
